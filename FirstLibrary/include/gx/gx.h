...
extern color_t gx_color       ( int red, int green, int blue);                    // 칼라 값을 구함
...
extern void    gx_border      ( dc_t *dc, int x1, int y1, int x2, int y2);        // 사각형의 테두리
extern void    gx_box         ( dc_t *dc, int x1, int y1, int x2, int y2);        // 내부가 채워진 사각형
