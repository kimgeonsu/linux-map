...
long CMapDrawEngine::DrawMap()
{
	...
	for (pos; pos != eee; pos++) {
		...
		{
			if ((strcmp(pData.header.textLayerDes, "강") == 0) ||
				(strcmp(pData.header.textLayerDes, "철도") == 0) ||
				(strcmp(pData.header.textLayerDes, "활주로") == 0) ||
				(strcmp(pData.header.textLayerDes, "도로") == 0))
			{
				continue;
			}
		}

		if ((strcmp(pData.header.textLayerDes, "공도") == 0) && (pData.header.isVisible == false))
		{
			continue;
		}
