...
public:
	...
	void GetLevel(long& level)
	{
		level = _level;
	}

	void SetParcelPos(Point parcelPos)
	{
		_parcelPos = parcelPos;
	};
	void SetParcelPos(long xPos, long yPos)
	{
		_parcelPos.x = xPos;
		_parcelPos.y = yPos;
	};
	...
	void GetParcelPos(Point& parcelPos)
	{
		parcelPos = _parcelPos;
	};
	void GetParcelPos(long& xPos, long& yPos)
	{
		xPos = _parcelPos.x;
		yPos = _parcelPos.y;
	};
	...
	void SetParcelID(Point parcelID)
	{
		_parcelID = parcelID;
	};
	void SetParcelID(long xPos, long yPos)
	{
		_parcelID.x = xPos;
		_parcelID.y = yPos;
	};
	...
	void GetParcelID(Point& parcelID)
	{
		parcelID = _parcelID;
	};
	void GetParcelID(long& xPos, long& yPos)
	{
		xPos = _parcelID.x;
		yPos = _parcelID.y;
	};
